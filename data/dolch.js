...
export const prePrimer = _prePrimer.split(",").map(s => s.trim());
export const primer = _primer.split(",").map(s => s.trim());
export const grade1 = _grade1.split(",").map(s => s.trim());
export const grade2 = _grade2.split(",").map(s => s.trim());
export const grade3 = _grade3.split(",").map(s => s.trim());
export const nouns = _nouns.split(",").map(s => s.trim());
